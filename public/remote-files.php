    ...
    <form id="remoteConnectionForm" autocomplete="off">
      ...
      <div class="modal-body">
        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-md-4"><label class="form-label" for="remoteConnectionUsername">Username</label><input class="form-control" id="remoteConnectionUsername" maxlength="320" autocomplete="off" required></div>
