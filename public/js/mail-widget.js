(function ($, window, document) {
    ...
    function addUi() {
        ...
        var modalHtml = ''
            ...
            + '<div class="modal-header mail-modal-header"><h5 class="modal-title" id="registerMailWidgetTitle"><i class="far fa-envelope" aria-hidden="true"></i> Mail Widgetを追加</h5><button type="button" class="btn-close" data-bs-theme="dark" data-bs-dismiss="modal" aria-label="閉じる"></button></div>'
            ...
            + '<div class="modal-header mail-modal-header"><h5 class="modal-title" id="changeMailWidgetTitle"><i class="far fa-envelope" aria-hidden="true"></i> Mail Widgetを変更</h5><button type="button" class="btn-close" data-bs-theme="dark" data-bs-dismiss="modal" aria-label="閉じる"></button></div>'
            ...
            + '<div class="modal-header mail-modal-header"><h5 class="modal-title" id="composeMailTitle"><i class="far fa-paper-plane" aria-hidden="true"></i> 新規Mail</h5><button type="button" class="btn-close" data-bs-theme="dark" data-bs-dismiss="modal" aria-label="閉じる"></button></div>'
