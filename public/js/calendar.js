(function (document) {
    ...
    loadStyle('./css/mail-widget.css?v=1.34.2-dev.1', 'data-mail-widget-style');
    loadStyle('./css/camera-video.css?v=1.34.2-dev.1', 'data-camera-video-style');
    loadStyle('./css/camera-video-playback.css?v=1.34.2-dev.1', 'data-camera-video-playback-style');
    loadStyle('./css/camera-video-streaming.css?v=1.34.2-dev.1', 'data-camera-video-streaming-style');
    loadStyle('./css/x-widget.css?v=1.34.2-dev.1', 'data-x-widget-style');
    loadStyle('./css/rss-rule-display.css?v=1.34.2-dev.1', 'data-rss-rule-display-style');
    ...
    loadStyle('./css/memo-refresh.css?v=1.34.2-dev.1', 'data-memo-refresh-style');
    // V1.20.1-C: event/Task color cues load after the legacy Calendar styles.
    loadStyle('./css/calendar-colors.css?v=1.34.2-dev.1', 'data-calendar-colors-style');
    // V1.25-C: all-day/time/URL fields and compact timed-event labels.
    loadStyle('./css/calendar-event-details.css?v=1.34.2-dev.1', 'data-calendar-event-details-style');
    // V1.25-D: recurring-event controls and compact recurrence marker.
    loadStyle('./css/calendar-recurrence.css?v=1.34.2-dev.1', 'data-calendar-recurrence-style');
    // V1.33-E: occurrence-only edit/cancel/restore scope controls.
    loadStyle('./css/calendar-occurrence.css?v=1.34.2-dev.1', 'data-calendar-occurrence-style');
    // V1.33-F: connected multi-day bars and fixed lanes inside each week.
    loadStyle('./css/calendar-month-layout.css?v=1.34.2-dev.1', 'data-calendar-month-layout-style');
    // V1.33-G: day/week/month switch, day timeline and compact week list.
    loadStyle('./css/calendar-views.css?v=1.34.2-dev.1', 'data-calendar-views-style');
    // V1.25-F: Today / upcoming / modal focus / Smartphone polish.
    loadStyle('./css/calendar-polish.css?v=1.34.2-dev.1', 'data-calendar-polish-style');
    // V1.25-F R3: compact upcoming list and month-switch height stabilization.
    loadStyle('./css/calendar-polish-r3.css?v=1.34.2-dev.1', 'data-calendar-polish-r3-style');
    loadStyle('./css/block-collapse.css?v=1.34.2-dev.1', 'data-block-collapse-style');
    loadStyle('./css/stock-state-ui.css?v=1.34.2-dev.1', 'data-stock-state-ui-style');
    ...
    loadScript('./js/app-notice.js?v=1.34.2-dev.1');
    loadScript('./js/stock-state-ui.js?v=1.34.2-dev.1');
    // V1.22-B: Feed Health observes feed.fetch responses and augments RSS settings.
    loadScript('./js/feed-health.js?v=1.34.2-dev.1');
    // V1.22-D: visual layer for server-evaluated RSS Rule highlights.
    loadScript('./js/rss-rule-display.js?v=1.34.2-dev.1');
    // V1.17.1-D/E: settings saves refresh only the affected card.
    loadScript('./js/widget-card-refresh.js?v=1.34.2-dev.1');
    // V1.20.1-B: target-only Memo refresh; no polling / page reload.
    loadScript('./js/memo-refresh.js?v=1.34.2-dev.1');
    ...
    loadScript('./js/information-widget-watchdog.js?v=1.34.2-dev.1');
    // V1.33-F: pure placement module is available before the DOM renderer.
    loadScript('./js/calendar-month-layout.js?v=1.34.2-dev.1');
    // V1.33-G: pure period and day-timeline calculations load before core.
    loadScript('./js/calendar-views.js?v=1.34.2-dev.1');
    loadScript('./js/calendar-core.js?v=1.34.2-dev.1');
    ...
    loadScript('./js/calendar-occurrence.js?v=1.34.2-dev.1');
    ...
    loadScript('./js/calendar-recurrence.js?v=1.34.2-dev.1');
    ...
    loadScript('./js/mail-widget-watchdog.js?v=1.34.2-dev.1');
    loadScript('./js/camera-video-watchdog.js?v=1.34.2-dev.1');
    loadScript('./js/mail-widget.js?v=1.34.2-dev.1');
    loadScript('./js/camera-video.js?v=1.34.2-dev.1');
    loadScript('./js/camera-video-playback.js?v=1.34.2-dev.1');
    loadScript('./js/camera-video-streaming.js?v=1.34.2-dev.1');
    // V1.17.2: X API timeline widget. Browser never receives the Bearer Token.
    loadScript('./js/x-widget.js?v=1.34.2-dev.1');
    ...
    loadScript('./js/widget-settings-no-reload.js?v=1.34.2-dev.1');
    ...
    loadScript('./js/drawer-categories.js?v=1.34.2-dev.1');
