(function (document) {
    ...
    loadStyle('./css/mail-widget.css?v=1.22.0', 'data-mail-widget-style');
    loadStyle('./css/camera-video.css?v=1.22.0', 'data-camera-video-style');
    loadStyle('./css/camera-video-playback.css?v=1.22.0', 'data-camera-video-playback-style');
    loadStyle('./css/camera-video-streaming.css?v=1.22.0', 'data-camera-video-streaming-style');
    loadStyle('./css/x-widget.css?v=1.22.0', 'data-x-widget-style');
    loadStyle('./css/rss-rule-display.css?v=1.22.0', 'data-rss-rule-display-style');
    ...
    loadStyle('./css/memo-refresh.css?v=1.22.0', 'data-memo-refresh-style');
    // V1.20.1-C: event/Task color cues load after the legacy Calendar styles.
    loadStyle('./css/calendar-colors.css?v=1.22.0', 'data-calendar-colors-style');
    loadStyle('./css/block-collapse.css?v=1.22.0', 'data-block-collapse-style');
    ...
    loadScript('./js/mail-widget-watchdog.js?v=1.22.0');
    loadScript('./js/camera-video-watchdog.js?v=1.22.0');
    loadScript('./js/mail-widget.js?v=1.22.0');
    loadScript('./js/camera-video.js?v=1.22.0');
    loadScript('./js/camera-video-playback.js?v=1.22.0');
    loadScript('./js/camera-video-streaming.js?v=1.22.0');
    // V1.17.2: X API timeline widget. Browser never receives the Bearer Token.
    loadScript('./js/x-widget.js?v=1.22.0');
    ...
    loadScript('./js/widget-settings-no-reload.js?v=1.22.0');
    ...
    loadScript('./js/drawer-categories.js?v=1.22.0');
})(document);
