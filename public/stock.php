...
if (is_int($content_location)) {
    ...
    for( $i = 0; $i < $result_content_cnt; $i++ ) {
                ...
                <section class="' . app_html($widgetWidthClass) . ' dashboard-widget feed-card" data-dashboard-widget-id="' . $widgetId . '" data-dashboard-widget-type="feed" data-dashboard-widget-location="' . (int) $content_location . '" data-dashboard-widget-sort-order="' . $widgetSortOrder . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-feed-item-limit="' . app_html($feedItemLimitAttr) . '" data-feed-content-id="' . $contentId . '" data-feed-state="loading" role="region" aria-labelledby="feed-title-' . $contentId . '" aria-busy="true">
                    <div class="feed-card-inner">
                        ...
                        <table class="table table-hover feed-table">
                            ...
                            <thead>
                                <tr><th colspan="3" scope="col" class="text-bg-' . app_html($contentStyle) . ' feed-card-header"><div class="feed-card-header-inner"><button type="button" class="btn btn-link widget-drag-handle" draggable="false" aria-describedby="widget-sort-help" aria-label="このWidgetを並び替え" aria-pressed="false" title="ここを掴んで並び替え"><i class="fas fa-grip-lines" aria-hidden="true"></i></button><small class="content-title widget-title-text" id="feed-title-' . $contentId . '"><span class="loading-inline"><i class="fas fa-spinner fa-spin" aria-hidden="true"></i><span>読み込み中...</span></span></small><span class="feed-card-actions"><button type="button" class="btn btn-link content-edit-trigger" data-content-id="' . $contentId . '" data-content-style="' . app_html($contentStyle) . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-feed-item-limit="' . app_html($feedItemLimitAttr) . '" data-bs-toggle="modal" data-bs-target="#changeContent" aria-label="このRSSを編集"><i class="fas fa-edit" aria-hidden="true"></i></button><button type="button" class="btn btn-link feed-refresh-trigger" aria-label="このRSSを更新" title="このRSSを更新"><i class="fas fa-sync-alt" aria-hidden="true"></i></button></span></div></th></tr>
                            </thead>
        ...
        if ($widgetType === 'search') {
            ...
            echo '<section class="' . app_html($widgetWidthClass) . ' dashboard-widget feed-card search-feed-card" data-dashboard-widget-id="' . $widgetId . '" data-dashboard-widget-type="search" data-dashboard-widget-location="' . (int) $content_location . '" data-dashboard-widget-sort-order="' . $widgetSortOrder . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-search-limit="' . $searchLimit . '" data-search-state="loading" role="region" aria-labelledby="' . app_html($searchTitleId) . '" aria-busy="true"><div class="feed-card-inner"><table class="table table-hover feed-table"><colgroup><col class="feed-stock-column"><col><col class="feed-summary-column"></colgroup><thead><tr><th colspan="3" class="content-header feed-card-header text-bg-' . app_html($widgetStyle) . '"><div class="content-header-row feed-card-header-inner"><button type="button" class="widget-drag-handle" aria-label="Search Feedを並び替え" aria-describedby="widget-sort-help">＝</button><span class="content-title widget-title-text" id="' . app_html($searchTitleId) . '"><span class="feed-title-text" title="' . app_html($searchQuery) . '">' . app_html($searchQuery) . '</span></span><span class="content-actions feed-card-actions"><button type="button" class="btn btn-link search-edit-trigger" data-widget-id="' . $widgetId . '" data-widget-style="' . app_html($widgetStyle) . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-search-query="' . app_html($searchQuery) . '" data-search-scope="' . app_html($searchScope) . '" data-search-condition="' . app_html($searchCondition) . '" data-search-limit="' . $searchLimit . '" data-search-category="' . app_html($searchCategory) . '" data-bs-toggle="modal" data-bs-target="#changeSearchFeed" aria-label="このSearch Feedを編集"><i class="fas fa-edit" aria-hidden="true"></i></button><button type="button" class="btn btn-link feed-refresh search-feed-refresh" aria-label="このSearch Feedを更新"><i class="fas fa-sync-alt" aria-hidden="true"></i></button></span></div></th></tr></thead><tbody class="content-body"><tr class="content-state-row"><td colspan="3" class="feed-state-message"><span class="loading-inline"><i class="fas fa-spinner fa-spin" aria-hidden="true"></i><span>検索しています</span></span></td></tr></tbody></table></div></section>';
            continue;
        }
            ...
            <!-- Clock Widget -->
                <section class="' . app_html($widgetWidthClass) . ' dashboard-widget clock-card" data-dashboard-widget-id="' . $widgetId . '" data-dashboard-widget-type="clock" data-dashboard-widget-location="' . (int) $content_location . '" data-dashboard-widget-sort-order="' . $widgetSortOrder . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-clock-title="' . app_html($clockTitle) . '" data-clock-hour-format="' . app_html($clockHourFormat) . '" data-clock-show-seconds="' . ($clockShowSeconds ? '1' : '0') . '" data-clock-show-date="' . ($clockShowDate ? '1' : '0') . '" role="region" aria-labelledby="' . app_html($clockTitleId) . '">
                    <div class="clock-card-inner">
                        <div class="text-bg-' . app_html($widgetStyle) . ' clock-card-header">
        ...
        if ($widgetType === 'game') {
            ...
            echo '<div class="text-bg-' . app_html($widgetStyle) . ' mini-game-card-header">';
            echo '<button type="button" class="btn btn-link widget-drag-handle" draggable="false" aria-describedby="widget-sort-help" aria-label="このWidgetを並び替え" aria-pressed="false" title="ここを掴んで並び替え"><i class="fas fa-grip-lines" aria-hidden="true"></i></button>';
            echo '<small class="mini-game-title widget-title-text" id="' . app_html($gameTitleId) . '" title="' . app_html($gameTitle) . '">' . app_html($gameTitle) . '</small>';
            echo '<button type="button" class="btn btn-link mini-game-edit-trigger" data-widget-id="' . $widgetId . '" data-widget-style="' . app_html($widgetStyle) . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-game-title="' . app_html($gameTitle) . '" data-game-type="' . app_html($gameType) . '" data-bs-toggle="modal" data-bs-target="#changeGameWidget" aria-label="このGame Widgetを編集"><i class="fas fa-edit" aria-hidden="true"></i></button>';
            echo '</div>';
            ...
            <!-- Memo Widget -->
                <section class="' . app_html($widgetWidthClass) . ' dashboard-widget memo-card" data-dashboard-widget-id="' . $widgetId . '" data-dashboard-widget-type="memo" data-dashboard-widget-location="' . (int) $content_location . '" data-dashboard-widget-sort-order="' . $widgetSortOrder . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-memo-id="' . $memoId . '" role="region" aria-labelledby="' . app_html($memoTitleId) . '">
                    <div class="memo-card-inner">
                        <div class="text-bg-' . app_html($widgetStyle) . ' memo-card-header">
                            <button type="button" class="btn btn-link widget-drag-handle" draggable="false" aria-describedby="widget-sort-help" aria-label="このWidgetを並び替え" aria-pressed="false" title="ここを掴んで並び替え"><i class="fas fa-grip-lines" aria-hidden="true"></i></button>
                            <small class="memo-title widget-title-text" id="' . app_html($memoTitleId) . '" title="' . app_html($memoTitle) . '">' . app_html($memoTitle) . '</small>
                            <button type="button" class="btn btn-link memo-edit-trigger" data-widget-id="' . $widgetId . '" data-memo-id="' . $memoId . '" data-widget-style="' . app_html($widgetStyle) . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-bs-toggle="modal" data-bs-target="#changeMemo" aria-label="このMemoを編集"><i class="fas fa-edit" aria-hidden="true"></i></button>
                        </div>
            ...
            <!-- Links Widget -->
                <section class="' . app_html($widgetWidthClass) . ' dashboard-widget links-card" data-dashboard-widget-id="' . $widgetId . '" data-dashboard-widget-type="links" data-dashboard-widget-location="' . (int) $content_location . '" data-dashboard-widget-sort-order="' . $widgetSortOrder . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" role="region" aria-labelledby="' . app_html($linksTitleId) . '">
                    <div class="links-card-inner">
                        <div class="text-bg-' . app_html($widgetStyle) . ' links-card-header">
                            <button type="button" class="btn btn-link widget-drag-handle" draggable="false" aria-describedby="widget-sort-help" aria-label="このWidgetを並び替え" aria-pressed="false" title="ここを掴んで並び替え"><i class="fas fa-grip-lines" aria-hidden="true"></i></button>
                            <small class="links-widget-title widget-title-text" id="' . app_html($linksTitleId) . '" title="' . app_html($linksTitle) . '">' . app_html($linksTitle) . '</small>
                            <button type="button" class="btn btn-link links-widget-edit-trigger" data-widget-id="' . $widgetId . '" data-links-title="' . app_html($linksTitle) . '" data-widget-style="' . app_html($widgetStyle) . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-bs-toggle="modal" data-bs-target="#changeLinksWidget" aria-label="このLinks Widgetを編集"><i class="fas fa-edit" aria-hidden="true"></i></button>
                        </div>
            ...
            <!-- Weather Widget -->
                <section class="' . app_html($widgetWidthClass) . ' dashboard-widget weather-card" data-dashboard-widget-id="' . $widgetId . '" data-dashboard-widget-type="weather" data-dashboard-widget-location="' . (int) $content_location . '" data-dashboard-widget-sort-order="' . $widgetSortOrder . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" role="region" aria-labelledby="' . app_html($weatherTitleId) . '">
                    <div class="weather-card-inner">
                        <div class="text-bg-' . app_html($widgetStyle) . ' weather-card-header">
                            <button type="button" class="btn btn-link widget-drag-handle" draggable="false" aria-describedby="widget-sort-help" aria-label="このWidgetを並び替え" aria-pressed="false" title="ここを掴んで並び替え"><i class="fas fa-grip-lines" aria-hidden="true"></i></button>
                            <small class="weather-widget-title widget-title-text" id="' . app_html($weatherTitleId) . '" title="' . app_html($weatherLocationName !== '' ? $weatherLocationName : $weatherTitle) . '">' . app_html($weatherTitle) . '</small>
                            <button type="button" class="btn btn-link weather-widget-edit-trigger" data-widget-id="' . $widgetId . '" data-weather-title="' . app_html($weatherTitle) . '" data-weather-location-query="' . app_html($weatherLocationQuery) . '" data-weather-forecast-days="' . $weatherForecastDays . '" data-widget-style="' . app_html($widgetStyle) . '" data-widget-width="' . $widgetWidth . '" data-widget-height="' . $widgetHeight . '" data-bs-toggle="modal" data-bs-target="#changeWeatherWidget" aria-label="このWeather Widgetを編集"><i class="fas fa-edit" aria-hidden="true"></i></button>
                            <button type="button" class="btn btn-link weather-refresh-trigger" aria-label="天気を更新" title="天気を更新"><i class="fas fa-sync-alt" aria-hidden="true"></i></button>
                        </div>
