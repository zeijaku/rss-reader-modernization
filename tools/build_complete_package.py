...
def collect() -> dict[str, bytes]:
    ...
    build = '\n'.join([
        ...
        'application_label=RSS Reader Modernization 1.20.1',
...
def main() -> int:
    parser = argparse.ArgumentParser(description='Build deterministic complete Version 1.20.1 source package.')
