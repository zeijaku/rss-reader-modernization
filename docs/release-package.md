...
|---|---|---|
| `rss-reader-modernization-1.3.0-complete.zip` | GitHub作業Folder相当の完全統合成果物 | 含む |
| `rss-reader-modernization-1.3.0.zip` | Server配置用Runtime成果物 | 含まない |
...
application_label=RSS Reader Modernization 1.3.0
...
`final` modeは`APP_VERSION = '1.3.0'`と`APP_VERSION_LABEL = 'RSS Reader Modernization 1.3.0'`が完全一致しない限り実行できません。
