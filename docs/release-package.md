...
|---|---|---|
| `rss-reader-modernization-1.8.0-complete.zip` | GitHubへ登録する完全Source | 含む |
| `rss-reader-modernization-1.8.0.zip` | Server配置用Runtime成果物 | 含まない |
...
application_label=RSS Reader Modernization 1.8.0
...
`final` modeは`APP_VERSION = '1.8.0'`と`APP_VERSION_LABEL = 'RSS Reader Modernization 1.8.0'`が完全一致しない限り実行できません。
