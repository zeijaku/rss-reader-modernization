 ...
 * V1.27-E3 uses a development revision for File Library upload UX and ZIP support.
 */
const APP_ASSET_REVISION = '1.27.0-dev-e3';

/**
 * V1.26-D: scoped cache key for the Information Board bootstrap chain.
 * V1.27-E3 does not change those assets, so keep the formal revision.
 */
