 ...
 */
const APP_VERSION = '1.28.0-dev.3';
const APP_VERSION_LABEL = 'RSS Reader Modernization 1.28.0-dev.3';

/**
 * Cache key for public assets.
 * Formal release assets use the same immutable cache key as APP_VERSION.
 * V1.28-D uses a checkpoint-specific revision so TXT Preview asset changes
 * do not reuse the previous V1.28-C browser cache.
 */
const APP_ASSET_REVISION = '1.28.0-dev.3';
