 ...
 */
const APP_VERSION = '1.28.0-dev.2';
const APP_VERSION_LABEL = 'RSS Reader Modernization 1.28.0-dev.2';

/**
 * Cache key for public assets.
 * Formal release assets use the same immutable cache key as APP_VERSION.
 * V1.28-C uses a checkpoint-specific revision so PDF Viewer asset changes
 * do not reuse the previous V1.28-B browser cache.
 */
const APP_ASSET_REVISION = '1.28.0-dev.2';
