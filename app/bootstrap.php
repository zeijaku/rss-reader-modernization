...
require_once __DIR__ . '/auth_session_registry.php';
require_once __DIR__ . '/session.php';
require_once __DIR__ . '/login_throttle.php';
require_once __DIR__ . '/auth.php';
require_once __DIR__ . '/auth_totp.php';
require_once __DIR__ . '/auth_recovery_code.php';
require_once __DIR__ . '/auth_audit_log.php';
...
require_once __DIR__ . '/auth_step_up.php';
