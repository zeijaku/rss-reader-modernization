...
{
    static $allowed = ['user_info', 'user_conf', 'content', 'content_stock', 'feed_item_state', 'memo', 'task', 'calendar_event', 'calendar_event_exception', 'dashboard_widget', 'notification', 'remember_token', 'link_item', 'stock_tag', 'stock_tag_map', 'feed_keyword', 'feed_metadata', 'auth_totp', 'auth_recovery_code', 'auth_session', 'auth_audit_log'];
