...
check(any(label in ''.join(p.text) for label in ['RSS Reader Modernization V1.1-G / R1','RSS Reader Modernization V1.1-H / R1','RSS Reader Modernization V1.1-I / R1','RSS Reader Modernization V1.1-I / R2','RSS Reader Modernization V1.1-J / R1','RSS Reader Modernization 1.1.0']) or 'RSS Reader Modernization 1.2.0-dev.3' or 'RSS Reader Modernization 1.2.0-dev.4' in ''.join(p.text),'Dashboard displays V1.1-G or later marker')
