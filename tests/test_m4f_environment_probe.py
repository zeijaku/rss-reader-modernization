...
check(data.get('checkpoint') == '1.1.0', 'environment probe records final checkpoint')
check(data.get('label') == 'RSS Reader Modernization 1.1.0', 'environment probe records final label')
