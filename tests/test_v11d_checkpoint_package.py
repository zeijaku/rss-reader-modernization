...
if len(sys.argv) != 2:
    raise SystemExit('usage: test_v11d_checkpoint_package.py <overlay.zip>')

archive = Path(sys.argv[1]).resolve()
assert archive.is_file(), f'ZIP not found: {archive}'
root_name = 'rss-reader-modernization-v1.1-d-r1-overlay/'
required = {
    root_name + 'APPLY_NOTE.md',
    root_name + 'app/dashboard_widget.php',
    root_name + 'app/version.php',
    root_name + 'database/migrations/003_v1_1_dashboard_widget.sql',
    root_name + 'database/audit/v1_1_d_preflight.sql',
    root_name + 'database/audit/v1_1_d_postflight.sql',
    root_name + 'tools/db_v11d.php',
    root_name + 'tests/test_v11d_dashboard_widget.php',
    root_name + 'tests/test_v11d_architecture.py',
    root_name + 'tests/test_v11d_sql.py',
    root_name + 'tests/test_v11d_dashboard_render.py',
    root_name + 'tests/test_v11d_runner.py',
    root_name + 'tests/test_m2c_dashboard_render.py',
    root_name + 'tests/test_m2d_dashboard_render.py',
    root_name + 'docs/v1-1-d-implementation.md',
    root_name + 'docs/v1-1-d-migration.md',
    root_name + 'docs/test-report-v1-1-d.md',
    root_name + 'docs/v1-1-d-overlay-manifest.txt',
...
with zipfile.ZipFile(archive) as zf:
    ...
    manifest_name = root_name + 'docs/v1-1-d-overlay-manifest.txt'
...
print(f'PASS: V1.1-D Overlay ZIP structure ({len(names)} entries)')
