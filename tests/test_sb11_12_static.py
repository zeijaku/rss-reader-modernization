...
check(bool(re.search(r"const APP_VERSION = '(?:(?:SB-(?:1[2-9]|[2-9]\d+)|M\d+-[A-Z]) R\d+|1\.0\.0(?:-rc\d+)?|1\.1\.0-dev\.\d+|1\.1\.0)';", version)), 'visible release marker is SB-12 or later / M-series / supported SemVer development')
