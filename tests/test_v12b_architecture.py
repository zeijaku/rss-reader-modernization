...
check('1.2.0-dev.3' in version or "APP_VERSION = '1.2.0'" in version or "APP_VERSION = '1.3.0-dev.1'" in version or "APP_VERSION = '1.3.0-dev.2'" in version or "APP_VERSION = '1.3.0-dev.3'" in version, 'Version marker identifies V1.2-B or a later checkpoint')
