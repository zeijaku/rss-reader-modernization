...
check(re.search(r"const APP_VERSION = '(?:1\.2\.0-dev\.[3-9][0-9]*|1\.(?:[2-9]|[1-9][0-9]+)\.\d+(?:-dev\.\d+)?)';", version) is not None, 'Version marker identifies V1.2-B or a later checkpoint')
