...
checks = {
    ...
    'stable loader refreshes streaming module': './js/camera-video-streaming.js?v=1.17.1' in calendar,
    'streaming fallback stylesheet uses stable cache key': './css/camera-video-streaming.css?v=1.17.1' in streaming,
}
