...
check("const APP_VERSION = '1.5.0-dev.1';" in version, 'Application Version is V1.5-B dev.1')
check("const APP_VERSION_LABEL = 'RSS Reader Modernization V1.5-B / R1';" in version, 'visible label identifies V1.5-B / R1')
