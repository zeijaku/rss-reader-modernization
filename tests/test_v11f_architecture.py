...
check((re.search(r"const APP_VERSION = '1\.1\.0-dev\.[5-9][0-9]*';", version) is not None and any(label in version for label in ['V1.1-F / R1','V1.1-G / R1','V1.1-H / R1','V1.1-I / R1','V1.1-I / R2','V1.1-J / R1'])) or ("const APP_VERSION = '1.1.0';" in version and 'RSS Reader Modernization 1.1.0' in version) or "const APP_VERSION = '1.2.0-dev.3';" in version, 'visible Version marker is V1.1-F or later')
