...
check("APP_VERSION = 'M4-E R1'" in version and "APP_VERSION_LABEL = 'Release M4-E / R1'" in version, 'visible version is M4-D R1')
...
check('M4-E完了はVersion 1.0.0 Release可を意味しない' in gate, 'later M4 stage does not claim final release readiness')
