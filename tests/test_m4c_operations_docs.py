...
check("APP_VERSION = '1.0.0'" in version and "APP_VERSION_LABEL = 'RSS Reader Modernization 1.0.0'" in version, 'visible version is M4-D R1')
check('| Installation / Update / Recovery | PASS |' in gate, 'M4-C release gate is PASS')
check('| Real environment evidence | DISCLOSED |' in gate, 'real environment evidence remains disclosed rather than fabricated')
check('未実施項目を架空のPASSへ変更していません' in gate, 'final release does not fabricate real environment readiness')
