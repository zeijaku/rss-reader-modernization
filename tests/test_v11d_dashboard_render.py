...
check('RSS Reader Modernization V1.1-' in ''.join(feed.text) or 'RSS Reader Modernization 1.1.0' in ''.join(feed.text) or 'RSS Reader Modernization 1.2.0-dev.1' in ''.join(feed.text), 'Dashboard displays a Version 1.1 marker')
