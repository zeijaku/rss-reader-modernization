...
check("const APP_ASSET_REVISION = '1.22.0-b';" in version, 'V1.22-B has a fresh asset revision')
check('./js/feed-health.js?v=1.22.0-b' in calendar, 'Dashboard loads Feed Health under the B asset key')
