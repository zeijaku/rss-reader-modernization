...
check('visible APP_VERSION keeps V1.17.1-C-or-later behavior', version_tuple >= (1, 17, 1))
...
check('V1.17.1-C-or-later asset revision is active', revision_tuple >= (1, 17, 1))
