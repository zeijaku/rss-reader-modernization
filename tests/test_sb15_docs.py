...
assert re.search(r"APP_VERSION = '(?:1\.1\.0-dev\.[1-9][0-9]*|1\.1\.0)'", version)
assert re.search(r"APP_VERSION_LABEL = '(?:RSS Reader Modernization V1\.1-[A-Z] / R[1-9][0-9]*|RSS Reader Modernization 1\.1\.0)'", version)
assert 'Secure Baseline SB-15 / R3' in readme
