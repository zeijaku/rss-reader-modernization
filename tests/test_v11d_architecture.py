...
check(("const APP_VERSION = '1.1.0-dev." in version and 'V1.1-' in version) or ("const APP_VERSION = '1.1.0';" in version and 'RSS Reader Modernization 1.1.0' in version), 'visible Version marker remains in the Version 1.1 line')
