...
check(('1.19.0' in release_builder and 'v1.19.0' in release_builder) or ('1.20.0' in release_builder and 'v1.20.0' in release_builder), 'Runtime builder targets V1.19 or a later V1.20 release line')
check("VERSION = '1.19.0'" in complete_builder or "VERSION = '1.20.0-rc1'" in complete_builder or "VERSION = '1.20.0'" in complete_builder, 'Complete builder targets V1.19 or a later V1.20 source')
check('1.19.0' in release_verifier or '1.20.0' in release_verifier, 'Runtime verifier targets V1.19 or a later V1.20 release line')
check("VERSION = '1.19.0'" in complete_verifier or "VERSION = '1.20.0-rc1'" in complete_verifier or "VERSION = '1.20.0'" in complete_verifier, 'Complete verifier targets V1.19 or a later V1.20 source')
