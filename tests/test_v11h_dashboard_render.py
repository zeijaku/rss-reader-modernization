...
check(any(label in ''.join(p.text) for label in ['RSS Reader Modernization V1.1-H / R1','RSS Reader Modernization V1.1-I / R1','RSS Reader Modernization V1.1-I / R2','RSS Reader Modernization V1.1-J / R1']),'Dashboard displays V1.1-H or later marker')
