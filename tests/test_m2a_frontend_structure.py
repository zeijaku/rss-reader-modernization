...
check(index.index("app_asset_url('js/bootstrap.bundle-5.3.8.min.js')") < index.index("app_asset_url('js/dashboard.js')"), 'Bootstrap 5 bundle loads before dashboard JavaScript')
check("app_asset_url('js/bootstrap.min.js')" not in index and "app_asset_url('js/drawer.min.js')" not in index and "app_asset_url('js/iscroll.js')" not in index and "app_asset_url('js/popper.min.js')" not in index, 'legacy Bootstrap 4 / Drawer / iScroll / standalone Popper runtime is absent')
check('data-bs-toggle="offcanvas"' in index and 'bootstrap.Offcanvas' in js, 'Bootstrap Offcanvas owns the dashboard drawer behavior')
