...
check("./js/calendar-copy.js?v=1.34.2-dev.8" in loader, 'Calendar copy module is loaded with the current dev.8 cache key')
occurrence_pos = loader.find("./js/calendar-occurrence.js?v=1.34.2-dev.8")
recurrence_pos = loader.find("./js/calendar-recurrence.js?v=1.34.2-dev.8")
detail_pos = loader.find("./js/calendar-event-details.js?v=1.34.2-dev.8")
copy_pos = loader.find("./js/calendar-copy.js?v=1.34.2-dev.8")
...
check("const APP_VERSION = '1.34.2-dev.8';" in version and "const APP_ASSET_REVISION = '1.34.2-dev.8';" in version, 'application and asset revisions are synchronized at 1.34.2-dev.8')
