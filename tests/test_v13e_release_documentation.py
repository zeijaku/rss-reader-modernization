...
FILES = [
    ...
    ROOT/'docs/v1-3-release-implementation.md', ROOT/'docs/v1-3-release-files.md',
    ROOT/'docs/test-report-v1-3-release.md', ROOT/'docs/release-gate-v1.3.0.md',
    ROOT/'docs/release-artifact-inventory-v1.3.0.md',
]
failed=[]; checked=0
