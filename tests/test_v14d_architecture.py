...
version=(ROOT/'app/version.php').read_text(); index = dashboard_source(ROOT); js=(ROOT/'public/js/mini-game.js').read_text(); css=(ROOT/'public/css/mini-game.css').read_text(); run=(ROOT/'tests/run.sh').read_text()
