...
check(("const APP_VERSION = '1.1.0-dev." in version and "RSS Reader Modernization V1.1-" in version) or ("const APP_VERSION = '1.1.0';" in version and "RSS Reader Modernization 1.1.0" in version) or "const APP_VERSION = '1.2.0-dev.3';" or "const APP_VERSION = '1.2.0-dev.4';" in version, 'visible Version marker remains a V1.1 checkpoint or final release')
