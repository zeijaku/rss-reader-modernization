...
check('**Current checkpoint:** `Release M4-E / R1`' in readme, 'README checkpoint is M4-D')
...
check("APP_VERSION = 'M4-E R1'" in version and "APP_VERSION_LABEL = 'Release M4-E / R1'" in version, 'visible version has advanced to M4-E R1')
...
check('M4-E完了はVersion 1.0.0 Release可を意味しない' in gate, 'M4-D does not claim final release readiness')
