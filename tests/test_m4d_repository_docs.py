...
check("APP_VERSION = 'M4-D R1'" in version and "APP_VERSION_LABEL = 'Release M4-D / R1'" in version, 'visible version is M4-D R1')
check('Current: `Release M4-D / R1`' in versioning, 'Version policy current marker is M4-D')
...
check('M4-D完了はVersion 1.0.0 Release可を意味しない' in gate, 'M4-D does not claim final release readiness')
