...
FILES=[
    ...
    ROOT/'docs/release-package.md', ROOT/'docs/tag-and-github-release.md', ROOT/'docs/github-v1-7-powershell.md',
    ROOT/'docs/v1-7-release-implementation.md', ROOT/'docs/v1-7-release-files.md',
    ROOT/'docs/test-report-v1-7-release.md', ROOT/'docs/release-gate-v1.7.0.md',
    ROOT/'docs/release-artifact-inventory-v1.7.0.md',
]
failed=[]; checked=0
