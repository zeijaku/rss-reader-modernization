...
FILES = [
    ...
    ROOT/'docs/v1-6-release-implementation.md', ROOT/'docs/v1-6-release-files.md',
    ROOT/'docs/test-report-v1-6-release.md', ROOT/'docs/release-gate-v1.6.0.md',
    ROOT/'docs/release-artifact-inventory-v1.6.0.md',
]
failed=[]; checked=0
