...
check('RSS Reader Modernization V1.1-' in ''.join(parser.text) or 'RSS Reader Modernization 1.1.0' in ''.join(parser.text), 'Dashboard displays a V1.1 Version marker')
