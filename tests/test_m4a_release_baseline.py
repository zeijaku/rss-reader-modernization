...
check("APP_VERSION = '1.0.0'" in version,'current application version has progressed to M4-E')
check("APP_VERSION_LABEL = 'RSS Reader Modernization 1.0.0'" in version,'current visible label has progressed to M4-E')
