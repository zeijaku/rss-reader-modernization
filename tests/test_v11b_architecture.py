...
check("V1.1 version marker remains set", "const APP_VERSION = '1.1.0-dev." in version or "const APP_VERSION = '1.1.0';" in version)
check("V1.1 checkpoint or final label remains set", ("RSS Reader Modernization V1.1-" in version and ("/ R1" in version or "/ R2" in version)) or "RSS Reader Modernization 1.1.0" in version)
