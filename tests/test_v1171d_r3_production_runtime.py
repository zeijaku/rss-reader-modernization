...
check('visible version is finalized at 1.17.1', "const APP_VERSION = '1.17.1';" in version)
check('stable asset revision active', "const APP_ASSET_REVISION = '1.17.1';" in version)
check('R3 helper is real runtime asset', "widget-card-refresh.js?v=1.17.1" in calendar)
check('R3 production interceptor is loaded', "widget-settings-no-reload.js?v=1.17.1" in calendar)
check('interceptor loads after Camera/Mail feature scripts', calendar.find('widget-settings-no-reload.js?v=1.17.1') > calendar.find('camera-video-streaming.js?v=1.17.1'))
