...
check("APP_VERSION = '1.0.0'" in version, 'current application version has advanced beyond M2-G')
check("APP_VERSION_LABEL = 'RSS Reader Modernization 1.0.0'" in version, 'current visible label has advanced beyond M2-G')
check('**Current release:** `RSS Reader Modernization 1.0.0`' in readme, 'README current checkpoint advances without removing M2-G history')
...
check('Current: `RSS Reader Modernization 1.0.0`' in versioning, 'Version policy current marker advances beyond M2-G')
check(checklist.startswith('# M4-G / R1'), 'User checklist targets current M4-G final checkpoint')
check(changelog.find('## RSS Reader Modernization 1.0.0 —') < changelog.find('## RSS Reader Modernization 1.0.0-RC1') < changelog.find('## Release M4-E / R1') < changelog.find('## Release M4-D / R1') < changelog.find('## Release M4-C / R1') < changelog.find('## Release M4-B / R1') < changelog.find('## Release M4-A / R1') < changelog.find('## Frontend M2-G / R1') < changelog.find('## Frontend M2-F / R1'), 'M2-G changelog history remains ordered below M4-E, M4-D, M4-C, M4-B and M4-A')
