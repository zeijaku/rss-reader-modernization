...
check("APP_VERSION = 'M4-B R1'" in version, 'current application version has advanced beyond M2-G')
check("APP_VERSION_LABEL = 'Release M4-B / R1'" in version, 'current visible label has advanced beyond M2-G')
check('**Current checkpoint:** `Release M4-B / R1`' in readme, 'README current checkpoint advances without removing M2-G history')
...
check('Current: `Release M4-B / R1`' in versioning, 'Version policy current marker advances beyond M2-G')
check(checklist.startswith('# M4-B / R1'), 'User checklist targets current M4-B checkpoint')
check(changelog.find('## Release M4-B / R1') < changelog.find('## Release M4-A / R1') < changelog.find('## Frontend M2-G / R1') < changelog.find('## Frontend M2-F / R1'), 'M2-G changelog history remains ordered below M4-B and M4-A')
