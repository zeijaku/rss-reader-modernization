...
check("APP_VERSION = 'M2-G R1'" in version, 'M2-G exact application version is set')
check("APP_VERSION_LABEL = 'Frontend M2-G / R1'" in version, 'M2-G exact visible label is set')
check('**Current checkpoint:** `Frontend M2-G / R1`' in readme, 'README current checkpoint is M2-G')
...
check('Current: `Frontend M2-G / R1`' in versioning, 'Version policy current marker is M2-G')
check(checklist.startswith('# M2-G / R1'), 'User checklist targets M2-G')
check(changelog.find('## Frontend M2-G / R1') < changelog.find('## Frontend M2-F / R1'), 'M2-G changelog entry is newest')
