...
FILES = [
    ...
    ROOT/'docs/v1-5-release-implementation.md', ROOT/'docs/v1-5-release-files.md',
    ROOT/'docs/test-report-v1-5-release.md', ROOT/'docs/release-gate-v1.5.0.md',
    ROOT/'docs/release-artifact-inventory-v1.5.0.md',
]
failed=[]; checked=0
