...
check("const APP_VERSION = '1.5.0-dev.2';" in version or "const APP_VERSION = '1.5.0';" in version, 'Application Version retains V1.5-C behavior')
check('RSS Reader Modernization V1.5-C / R' in version or "APP_VERSION_LABEL = 'RSS Reader Modernization 1.5.0'" in version, 'visible label identifies V1.5-C or final release')
