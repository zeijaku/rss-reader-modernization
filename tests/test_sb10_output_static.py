...
check("LIBXML_NONET" in common_func, 'XML parser forbids network access')
check("@simplexml_load_string" not in common_func, 'XML parse errors are not hidden with @')
