...
check("./css/dashboard-card-wheel.css?v=1.34.2-dev.9" in loader,
...
check("const APP_VERSION = '1.34.2-dev.9';" in version and
      "const APP_ASSET_REVISION = '1.34.2-dev.9';" in version,
