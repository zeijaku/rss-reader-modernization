...
check('workflow_dispatch:' in release, 'Release workflow is manually dispatched')
check('pull_request:' not in release and '\n  push:' not in release, 'Release workflow is not triggered by PR or push')
