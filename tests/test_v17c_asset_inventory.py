...
check("defined('APP_ASSET_REVISION')" in asset_php and 'APP_VERSION' in asset_php and 'rawurlencode($revision)' in asset_php, 'Asset URLs use the dedicated revision with Application Version fallback')
