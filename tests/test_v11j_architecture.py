...
check("const APP_VERSION = '1.1.0-dev.9';" in version or "const APP_VERSION = '1.1.0';" in version or "const APP_VERSION = '1.2.0-dev.2';" in version, 'application version is V1.1-J dev.9 or final 1.1.0')
check("const APP_VERSION_LABEL = 'RSS Reader Modernization V1.1-J / R1';" in version or "const APP_VERSION_LABEL = 'RSS Reader Modernization 1.1.0';" in version or "const APP_VERSION = '1.2.0-dev.2';" in version or "const APP_VERSION_LABEL = 'RSS Reader Modernization 1.2.0-dev.2';" in version, 'visible version label identifies V1.1-J or final 1.1.0')
