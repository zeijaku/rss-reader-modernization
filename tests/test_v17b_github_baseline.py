...
check('intended_tag=none-before-v1.7.0' in build or 'intended_tag=v1.7.0' in build or ('package_type=complete-source' in build and is_later_application_release(version, (1, 7, 0))), 'Tag metadata is valid for checkpoint or superseded by a later complete-source package')
