...
check('feed-stock-column' in index and '.feed-stock-column' in css, 'Feed Stock column hook remains')
check('width: 44px' in css, 'Feed Stock action column remains 44px')
