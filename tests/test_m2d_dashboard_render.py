...
check('feed-actions-column' in index and '.feed-actions-column' in css, 'Feed article Actions column hook remains')
check('width: 90px' in css and 'min-height: 44px' in css, 'Feed article Actions column supports two touch-sized controls')
