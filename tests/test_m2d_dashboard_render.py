...
check('Frontend M2-F / R1' in feed_text, 'Feed Dashboard displays current version')
...
check('Frontend M2-F / R1' in stock_text, 'Stock Dashboard displays current version')
