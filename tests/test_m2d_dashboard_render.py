...
check('Frontend M2-E / R2' in feed_text, 'Feed Dashboard displays current version')
...
check('Frontend M2-E / R2' in stock_text, 'Stock Dashboard displays current version')
