...
check('Release M4-A / R1' in feed_text, 'Feed Dashboard displays current version')
...
check('Release M4-A / R1' in stock_text, 'Stock Dashboard displays current version')
