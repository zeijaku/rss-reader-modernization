...
check('RSS Reader Modernization 1.0.0-RC1' in feed_text, 'Feed Dashboard displays current version')
...
check('RSS Reader Modernization 1.0.0-RC1' in stock_text, 'Stock Dashboard displays current version')
