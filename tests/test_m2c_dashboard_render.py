...
check('<h1 class="visually-hidden">iGuguru RSS Reader</h1>' in index, 'Dashboard keeps a Bootstrap 5 visually hidden page heading for assistive technology')
...
check('aria-controls="drawerMenu"' in index and 'aria-expanded="false"' in index, 'Offcanvas triggers keep expanded-state semantics')
check('id="drawerMenu"' in index and 'aria-labelledby="drawerMenuLabel"' in index and 'id="drawerMenuLabel"' in index, 'Offcanvas navigation remains named')
